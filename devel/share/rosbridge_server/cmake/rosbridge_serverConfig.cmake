...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/kbs/catkin_ws2/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/kbs/catkin_ws2/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/kbs/catkin_ws2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kbs/catkin_ws2/src/rosbridge_suite/rosbridge_server/${idir}'.  ${_report}")
    endif()
