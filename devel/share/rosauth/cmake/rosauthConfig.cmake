...
if("TRUE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /home/kbs/catkin_ws2/src/rosauth)
  set(rosauth_DEVEL_PREFIX /home/kbs/catkin_ws2/devel)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /home/kbs/catkin_ws2/install)
...
if(NOT "/home/kbs/catkin_ws2/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kbs/catkin_ws2/src/rosauth/${idir}'.  ${_report}")
    endif()
